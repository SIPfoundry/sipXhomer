...
#ifdef _OS_DISABLE_LOGGING
  #define OS_LOG_DEBUG(facility, data)
  #define OS_LOG_INFO(facility, data)
  #define OS_LOG_NOTICE(facility, data)
  #define OS_LOG_WARNING(facility, data)
  #define OS_LOG_ERROR(facility, data)
  #define OS_LOG_CRITICAL(facility, data)
  #define OS_LOG_ALERT(facility, data)
  #define OS_LOG_EMERGENCY(facility, data)
#else
